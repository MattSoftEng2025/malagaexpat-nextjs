...
export default function AboutMalaga() {

    return (
        <>
            <Head>
                <title>About Malaga - Malaga Expat proto</title>
            </Head>
                    ...
                    <div className="columns content is-medium">
                        <div className="column is-7">
                            <div className="content">
                                <p>Malaga is one of the eight provinces of the Autonomous Spanish community of Andalusia. The province itself is divided into six comarcas (regions) which are: Metropolitan area of Malaga, Costa del Sol Occidental, Guadalhorce Valley, La Axarquia, Serrania de Ronda and Comarca de Antequera. Within those regions there are in total 101 municipalities.</p>
                                <p>The city of Malaga, the second largest in the Andalusia, had been in the past often ignored by the tourists heading directly to the Costa del Sol resorts, but the city has been revitalised and become extremely popular. Its vibrancy, diversity and style combined with fantastic offer of museums, beaches, shops and restaurants have earned Malaga the reputation of one of Europe’s best cities to visit and live in.</p>
